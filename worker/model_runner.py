...
class ModelRunner:
    ...
    def _prepare_prompt(
        ...
        seq_group_metadata_list: List[SequenceGroupMetadata],
               ...
               List[int], List[int], Set[LoRARequest], Optional[MultiModalData]]:
    ...
    def _prepare_decode(
        ...
        seq_group_metadata_list: List[SequenceGroupMetadata],
               ...
               Set[LoRARequest], Optional[MultiModalData]]:
        assert len(seq_group_metadata_list) > 0
        input_tokens: List[List[int]] = []
        input_positions: List[List[int]] = []
        slot_mapping: List[List[int]] = []
    ...
    def prepare_input_tensors(
        ...
        seq_group_metadata_list: Optional[List[SequenceGroupMetadata]],
               ...
               Set[int], LoRAMapping, Optional[MultiModalData]]:
        if self.is_driver_worker:
            ...
            if is_prompt:
                (input_tokens, input_positions, input_metadata, prompt_lens,
                 subquery_lens, lora_index_mapping, lora_prompt_mapping,
                 lora_requests, multi_modal_input,) = self._prepare_prompt(seq_group_metadata_list)
            else:
                (input_tokens, input_positions, input_metadata,
                 lora_index_mapping, lora_prompt_mapping,
                 lora_requests, multi_modal_input,) = self._prepare_decode(seq_group_metadata_list)
                prompt_lens = []
                subquery_lens = None
    ...
    def execute_model(
        ...
        (input_tokens, input_positions, input_metadata, sampling_metadata,
         lora_requests,
         lora_mapping, multi_modal_input) = self.prepare_input_tensors(seq_group_metadata_list)
